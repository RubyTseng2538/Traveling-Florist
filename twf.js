...
function check_win_condition(){
  if(health >= 10){
    result = "<p>"
    win_message = {
      "sentence" : [p1+"'s traveling flower business became a #size# success, and they were featured in #number# magazines and newspapers for their #adj# and #adj# approach to floral design. Years went by, and "+p1+"'s business continued to thrive. They traveled to new countries and cities, learning about different floral traditions and cultures and incorporating them into their own work. " +p1+" realized that their true passion wasn't just about selling flowers - it was about bringing joy and beauty into people's lives through their #item#. And that's exactly what they did, one #adjective# arrangement at a time.",
